    ...
    <div class="form-group">
      ...
      <select class="form-control" id="Selectionner le pays" name="commune_id" required>
          ...
          @foreach ($ville as $vil )
              <option aria-placeholder="Commune " value="{{$vil->id}}">{{$vil->libelleCommune}}</option>
          @endforeach
        </select>
      </div>

  <div class="card-footer">
  <button type="serach" class="btn btn-warning"> <span class="fas fa-search">  </span>Chercher</button>
  </div>
  </form>
